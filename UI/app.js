    ...
    dz.on("complete", function (file) {
        ...
        $.post(url, {
            ...
            */
            ...
            let players = ["arijit_singh", "carry_minati", "cristiano_ronaldo", "deepika_padukone", "indian_hacker","kapil_sharma","pew_die_pie","sandeep_maheshwari","technical_guruji","virat_kohli"];
...
//This function is called when the HTML file is getting rendered by the browser so this gets hides at first.
